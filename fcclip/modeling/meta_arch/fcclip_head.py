...
class FCCLIPHead(nn.Module):
    ...
    def layers(self, features, batched_inputs, mask=None):
        mask_features, transformer_encoder_features, multi_scale_features = self.pixel_decoder.forward_features(features, batched_inputs) #mask_features [1,256,256,256] multi_scale_features [1,256,32,32],[1,256,64,64],[1,256,128,128]
